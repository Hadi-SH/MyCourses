namespace MyCourses.Migrations
{
    ...
    public partial class FullDB : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        AdmissionTerms_Id = c.Int(),
                        Majors_Id = c.Byte(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.AdmissionTerms", t => t.AdmissionTerms_Id)
                .ForeignKey("dbo.Majors", t => t.Majors_Id)
                .Index(t => t.AdmissionTerms_Id)
                .Index(t => t.Majors_Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Students", "AdmissionTerms_Id", "dbo.AdmissionTerms");
            ...
            DropIndex("dbo.Students", new[] { "AdmissionTerms_Id" });
